...
// Defines values for Box2ShapeType.
const (
	Box2ShapeTypeBox Box2ShapeType = "box"
)

// Defines values for Box2Type.
const (
	FULL   Box2Type = "FULL"
	HOLLOW Box2Type = "HOLLOW"
)

// Defines values for Capsule2ShapeType.
const (
	Capsule2ShapeTypeCapsule Capsule2ShapeType = "capsule"
)

// Defines values for ControllerKind.
const (
	ControllerKindAbbController             ControllerKind = "AbbController"
	ControllerKindFanucController           ControllerKind = "FanucController"
	ControllerKindUniversalrobotsController ControllerKind = "UniversalrobotsController"
	ControllerKindVirtualController         ControllerKind = "VirtualController"
	ControllerKindYaskawaController         ControllerKind = "YaskawaController"
)

// Defines values for ConvexHull2ShapeType.
const (
	ConvexHull2ShapeTypeConvexHull ConvexHull2ShapeType = "convex_hull"
)

// Defines values for Cylinder2ShapeType.
const (
	Cylinder2ShapeTypeCylinder Cylinder2ShapeType = "cylinder"
)
...
// Defines values for Plane2ShapeType.
const (
	Plane2ShapeTypePlane Plane2ShapeType = "plane"
)

// Defines values for Rectangle2ShapeType.
const (
	Rectangle2ShapeTypeRectangle Rectangle2ShapeType = "rectangle"
)

// Defines values for RectangularCapsule2ShapeType.
const (
	RectangularCapsule2ShapeTypeRectangularCapsule RectangularCapsule2ShapeType = "rectangular_capsule"
)
...
// Defines values for Sphere2ShapeType.
const (
	Sphere2ShapeTypeSphere Sphere2ShapeType = "sphere"
)
...
const (
	...
	UniversalrobotsUr5   VirtualControllerTypes = "universalrobots-ur5"
...
// AbbController defines model for AbbController.
...
type App struct {
	...
	// Name The name of the user provided application.
	...
	// Path The url path the app is listening on.
...
type Box2 struct {
	ShapeType Box2ShapeType `json:"shape_type"`
	SizeX     float32       `json:"size_x"`
	SizeY     float32       `json:"size_y"`
	SizeZ     float32       `json:"size_z"`
	Type      Box2Type      `json:"type"`
}

// Box2ShapeType defines model for Box2.ShapeType.
type Box2ShapeType string

// Box2Type defines model for Box2.Type.
type Box2Type string
...
// Capsule2 Centered around origin, symmetric around z-axis.
type Capsule2 struct {
	CylinderHeight float32           `json:"cylinder_height"`
	Radius         float32           `json:"radius"`
	ShapeType      Capsule2ShapeType `json:"shape_type"`
}

// Capsule2ShapeType defines model for Capsule2.ShapeType.
type Capsule2ShapeType string
...
type Cell struct {
	...
	// Name A unique name for the cell used as a unique identifier for addressing the cell in all API calls.
...
// ControllerKind defines model for ControllerKind.
...
// ConvexHull2 Convex hull around all vertices.
type ConvexHull2 struct {
	ShapeType ConvexHull2ShapeType             `json:"shape_type"`
	Vertices  []PyjectoryDatatypesCorePosition `json:"vertices"`
}

// ConvexHull2ShapeType defines model for ConvexHull2.ShapeType.
type ConvexHull2ShapeType string
...
// Cylinder2 Centered around origin, symmetric around z-axis.
//
// If margin is applied, it is added to radius and height (shape still has edges).
type Cylinder2 struct {
	Height    float32            `json:"height"`
	Radius    float32            `json:"radius"`
	ShapeType Cylinder2ShapeType `json:"shape_type"`
}

// Cylinder2ShapeType defines model for Cylinder2.ShapeType.
type Cylinder2ShapeType string
...
// ExecuteToTrajectoryRequest A request to move to one location on a previously planned motion via a p2p motion.
type ExecuteToTrajectoryRequest struct {
	...
	// ResponsesCoordinateSystem Unique identifier of a coordinate system to which the responses should be converted to. Default is the world coordinate system.
	// Default coordinate system is world.
	ResponsesCoordinateSystem *string `json:"responses_coordinate_system,omitempty"`
}
...
// FanucController defines model for FanucController.
...
// FoundationServiceProgramStore The configuration overwrite for the program store.
type FoundationServiceProgramStore struct {
	// ImageOverwrite Override the default container image with a custom one.
	ImageOverwrite *DeveloperImage `json:"imageOverwrite,omitempty"`
}
...
type FoundationServices struct {
	...
	// Programstore The configuration overwrite for the program store.
	Programstore *FoundationServiceProgramStore `json:"programstore,omitempty"`
...
// MoveRequest A request to move the joints of a motion group.
...
type PlanSuccessfulResponse struct {
	...
	// `joints` must have as many entries as the motion group's degrees of freedom to be valid.
	// Float precision is the default.
	EndJointPosition *Joints `json:"end_joint_position,omitempty"`
...
// Plane2 XY-plane.
type Plane2 struct {
	ShapeType Plane2ShapeType `json:"shape_type"`
}

// Plane2ShapeType defines model for Plane2.ShapeType.
type Plane2ShapeType string
...
// Rectangle2 Centered in XY-plane.
type Rectangle2 struct {
	ShapeType Rectangle2ShapeType `json:"shape_type"`
	SizeX     float32             `json:"size_x"`
	SizeY     float32             `json:"size_y"`
}

// Rectangle2ShapeType defines model for Rectangle2.ShapeType.
type Rectangle2ShapeType string
...
// RectangularCapsule2 Convex hull around four spheres. Sphere center points in XY-plane, offset by either combination "+/- sizeX" or "+/- sizeY".
//
// Alternative description: Rectangle in x-y-plane with a 3D padding.
type RectangularCapsule2 struct {
	Radius                float32                      `json:"radius"`
	ShapeType             RectangularCapsule2ShapeType `json:"shape_type"`
	SphereCenterDistanceX float32                      `json:"sphere_center_distance_x"`
	SphereCenterDistanceY float32                      `json:"sphere_center_distance_y"`
}

// RectangularCapsule2ShapeType defines model for RectangularCapsule2.ShapeType.
type RectangularCapsule2ShapeType string
...
// Sphere2 Centered around origin.
type Sphere2 struct {
	Radius    float32          `json:"radius"`
	ShapeType Sphere2ShapeType `json:"shape_type"`
}

// Sphere2ShapeType defines model for Sphere2.ShapeType.
type Sphere2ShapeType string
...
// UniversalrobotsController defines model for UniversalrobotsController.
...
// UpdateRequest An update is defined by the indicated Wandelbots Nova version.
// The version has to be a valid [semver](https://github.com/Masterminds/semver) string.
type UpdateRequest struct {
	// Version The indicated Wandelbots Nova version.
...
// VirtualController defines model for VirtualController.
...
// YaskawaController defines model for YaskawaController.
...
// AppID The name of the user provided application.
// The name must be unique within the cell and is used as a identifier for addressing the application in all API calls, e.g. when updating the application.
type AppID = string
...
// StreamMotionGroupStateJSONBody defines parameters for StreamMotionGroupState.
type StreamMotionGroupStateJSONBody struct {
	// ResponseCoordinateSystem Unique identifier addressing a coordinate system to which the responses should be converted.
	// If not set, world coordinate system is used.
	ResponseCoordinateSystem *string `json:"response_coordinate_system,omitempty"`

	// ResponseRate In milliseconds (ms). Unit transfer: 200 ms = 5 Hz, 4 ms = 250 Hz
...
// StreamMotionGroupStateJSONRequestBody defines body for StreamMotionGroupState for application/json ContentType.
type StreamMotionGroupStateJSONRequestBody StreamMotionGroupStateJSONBody
...
// StreamMoveBackwardJSONRequestBody defines body for StreamMoveBackward for application/json ContentType.
type StreamMoveBackwardJSONRequestBody = MoveRequest

// StreamMoveForwardJSONRequestBody defines body for StreamMoveForward for application/json ContentType.
type StreamMoveForwardJSONRequestBody = MoveRequest

// StreamMoveToTrajectoryViaJointPTPJSONRequestBody defines body for StreamMoveToTrajectoryViaJointPTP for application/json ContentType.
type StreamMoveToTrajectoryViaJointPTPJSONRequestBody = ExecuteToTrajectoryRequest
...
// UpdateFoundationServicesJSONRequestBody defines body for UpdateFoundationServices for application/json ContentType.
type UpdateFoundationServicesJSONRequestBody = FoundationServices
...
type UpdateNovaVersionJSONRequestBody = UpdateRequest
...
// AsSphere2 returns the union data inside the ColliderInput_Shape as a Sphere2
func (t ColliderInput_Shape) AsSphere2() (Sphere2, error) {
	var body Sphere2
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromSphere2 overwrites any union data inside the ColliderInput_Shape as the provided Sphere2
func (t *ColliderInput_Shape) FromSphere2(v Sphere2) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeSphere2 performs a merge with any union data inside the ColliderInput_Shape, using the provided Sphere2
func (t *ColliderInput_Shape) MergeSphere2(v Sphere2) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsBox2 returns the union data inside the ColliderInput_Shape as a Box2
func (t ColliderInput_Shape) AsBox2() (Box2, error) {
	var body Box2
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromBox2 overwrites any union data inside the ColliderInput_Shape as the provided Box2
func (t *ColliderInput_Shape) FromBox2(v Box2) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeBox2 performs a merge with any union data inside the ColliderInput_Shape, using the provided Box2
func (t *ColliderInput_Shape) MergeBox2(v Box2) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsRectangle2 returns the union data inside the ColliderInput_Shape as a Rectangle2
func (t ColliderInput_Shape) AsRectangle2() (Rectangle2, error) {
	var body Rectangle2
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromRectangle2 overwrites any union data inside the ColliderInput_Shape as the provided Rectangle2
func (t *ColliderInput_Shape) FromRectangle2(v Rectangle2) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeRectangle2 performs a merge with any union data inside the ColliderInput_Shape, using the provided Rectangle2
func (t *ColliderInput_Shape) MergeRectangle2(v Rectangle2) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsPlane2 returns the union data inside the ColliderInput_Shape as a Plane2
func (t ColliderInput_Shape) AsPlane2() (Plane2, error) {
	var body Plane2
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromPlane2 overwrites any union data inside the ColliderInput_Shape as the provided Plane2
func (t *ColliderInput_Shape) FromPlane2(v Plane2) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergePlane2 performs a merge with any union data inside the ColliderInput_Shape, using the provided Plane2
func (t *ColliderInput_Shape) MergePlane2(v Plane2) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsCylinder2 returns the union data inside the ColliderInput_Shape as a Cylinder2
func (t ColliderInput_Shape) AsCylinder2() (Cylinder2, error) {
	var body Cylinder2
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromCylinder2 overwrites any union data inside the ColliderInput_Shape as the provided Cylinder2
func (t *ColliderInput_Shape) FromCylinder2(v Cylinder2) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeCylinder2 performs a merge with any union data inside the ColliderInput_Shape, using the provided Cylinder2
func (t *ColliderInput_Shape) MergeCylinder2(v Cylinder2) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsCapsule2 returns the union data inside the ColliderInput_Shape as a Capsule2
func (t ColliderInput_Shape) AsCapsule2() (Capsule2, error) {
	var body Capsule2
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromCapsule2 overwrites any union data inside the ColliderInput_Shape as the provided Capsule2
func (t *ColliderInput_Shape) FromCapsule2(v Capsule2) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeCapsule2 performs a merge with any union data inside the ColliderInput_Shape, using the provided Capsule2
func (t *ColliderInput_Shape) MergeCapsule2(v Capsule2) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsRectangularCapsule2 returns the union data inside the ColliderInput_Shape as a RectangularCapsule2
func (t ColliderInput_Shape) AsRectangularCapsule2() (RectangularCapsule2, error) {
	var body RectangularCapsule2
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromRectangularCapsule2 overwrites any union data inside the ColliderInput_Shape as the provided RectangularCapsule2
func (t *ColliderInput_Shape) FromRectangularCapsule2(v RectangularCapsule2) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeRectangularCapsule2 performs a merge with any union data inside the ColliderInput_Shape, using the provided RectangularCapsule2
func (t *ColliderInput_Shape) MergeRectangularCapsule2(v RectangularCapsule2) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsConvexHull2 returns the union data inside the ColliderInput_Shape as a ConvexHull2
func (t ColliderInput_Shape) AsConvexHull2() (ConvexHull2, error) {
	var body ConvexHull2
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromConvexHull2 overwrites any union data inside the ColliderInput_Shape as the provided ConvexHull2
func (t *ColliderInput_Shape) FromConvexHull2(v ConvexHull2) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeConvexHull2 performs a merge with any union data inside the ColliderInput_Shape, using the provided ConvexHull2
func (t *ColliderInput_Shape) MergeConvexHull2(v ConvexHull2) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
type ClientInterface interface {
	...
	// StreamMotionGroupStateWithBody request with any body
	StreamMotionGroupStateWithBody(ctx context.Context, cellID CellID, motionGroup MotionGroup, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	StreamMotionGroupState(ctx context.Context, cellID CellID, motionGroup MotionGroup, body StreamMotionGroupStateJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	// StreamMoveBackwardWithBody request with any body
	StreamMoveBackwardWithBody(ctx context.Context, cellID CellID, motion Motion, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	StreamMoveBackward(ctx context.Context, cellID CellID, motion Motion, body StreamMoveBackwardJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// StreamMoveForwardWithBody request with any body
	StreamMoveForwardWithBody(ctx context.Context, cellID CellID, motion Motion, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	StreamMoveForward(ctx context.Context, cellID CellID, motion Motion, body StreamMoveForwardJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// StreamMoveToTrajectoryViaJointPTPWithBody request with any body
	StreamMoveToTrajectoryViaJointPTPWithBody(ctx context.Context, cellID CellID, motion Motion, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	StreamMoveToTrajectoryViaJointPTP(ctx context.Context, cellID CellID, motion Motion, body StreamMoveToTrajectoryViaJointPTPJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	DeployCellWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	DeployCell(ctx context.Context, body DeployCellJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// DeleteCell request
	DeleteCell(ctx context.Context, cellID CellID, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	UpdateCellWithBody(ctx context.Context, cellID CellID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	UpdateCell(ctx context.Context, cellID CellID, body UpdateCellJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// ClearApps request
	ClearApps(ctx context.Context, cellID CellID, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	AddAppWithBody(ctx context.Context, cellID CellID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	AddApp(ctx context.Context, cellID CellID, body AddAppJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// DeleteApp request
	DeleteApp(ctx context.Context, cellID CellID, appID AppID, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	UpdateAppWithBody(ctx context.Context, cellID CellID, appID AppID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	UpdateApp(ctx context.Context, cellID CellID, appID AppID, body UpdateAppJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// ClearRobotControllers request
	ClearRobotControllers(ctx context.Context, cellID CellID, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	AddRobotControllerWithBody(ctx context.Context, cellID CellID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	AddRobotController(ctx context.Context, cellID CellID, body AddRobotControllerJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// DeleteRobotController request
	DeleteRobotController(ctx context.Context, cellID CellID, controllerID ControllerID, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	UpdateRobotControllerWithBody(ctx context.Context, cellID CellID, controllerID ControllerID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	UpdateRobotController(ctx context.Context, cellID CellID, controllerID ControllerID, body UpdateRobotControllerJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetFoundationServices request
	GetFoundationServices(ctx context.Context, cellID CellID, reqEditors ...RequestEditorFn) (*http.Response, error)

	// UpdateFoundationServicesWithBody request with any body
	UpdateFoundationServicesWithBody(ctx context.Context, cellID CellID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	UpdateFoundationServices(ctx context.Context, cellID CellID, body UpdateFoundationServicesJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) StreamMotionGroupStateWithBody(ctx context.Context, cellID CellID, motionGroup MotionGroup, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewStreamMotionGroupStateRequestWithBody(c.Server, cellID, motionGroup, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) StreamMotionGroupState(ctx context.Context, cellID CellID, motionGroup MotionGroup, body StreamMotionGroupStateJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewStreamMotionGroupStateRequest(c.Server, cellID, motionGroup, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) StreamMoveBackwardWithBody(ctx context.Context, cellID CellID, motion Motion, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewStreamMoveBackwardRequestWithBody(c.Server, cellID, motion, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) StreamMoveBackward(ctx context.Context, cellID CellID, motion Motion, body StreamMoveBackwardJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewStreamMoveBackwardRequest(c.Server, cellID, motion, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) StreamMoveForwardWithBody(ctx context.Context, cellID CellID, motion Motion, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewStreamMoveForwardRequestWithBody(c.Server, cellID, motion, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) StreamMoveForward(ctx context.Context, cellID CellID, motion Motion, body StreamMoveForwardJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewStreamMoveForwardRequest(c.Server, cellID, motion, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) StreamMoveToTrajectoryViaJointPTPWithBody(ctx context.Context, cellID CellID, motion Motion, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewStreamMoveToTrajectoryViaJointPTPRequestWithBody(c.Server, cellID, motion, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) StreamMoveToTrajectoryViaJointPTP(ctx context.Context, cellID CellID, motion Motion, body StreamMoveToTrajectoryViaJointPTPJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewStreamMoveToTrajectoryViaJointPTPRequest(c.Server, cellID, motion, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) DeployCellWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewDeployCellRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) DeployCell(ctx context.Context, body DeployCellJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewDeployCellRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) DeleteCell(ctx context.Context, cellID CellID, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewDeleteCellRequest(c.Server, cellID)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) UpdateCellWithBody(ctx context.Context, cellID CellID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdateCellRequestWithBody(c.Server, cellID, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) UpdateCell(ctx context.Context, cellID CellID, body UpdateCellJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdateCellRequest(c.Server, cellID, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) ClearApps(ctx context.Context, cellID CellID, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewClearAppsRequest(c.Server, cellID)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) AddAppWithBody(ctx context.Context, cellID CellID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewAddAppRequestWithBody(c.Server, cellID, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) AddApp(ctx context.Context, cellID CellID, body AddAppJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewAddAppRequest(c.Server, cellID, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) DeleteApp(ctx context.Context, cellID CellID, appID AppID, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewDeleteAppRequest(c.Server, cellID, appID)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) UpdateAppWithBody(ctx context.Context, cellID CellID, appID AppID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdateAppRequestWithBody(c.Server, cellID, appID, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) UpdateApp(ctx context.Context, cellID CellID, appID AppID, body UpdateAppJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdateAppRequest(c.Server, cellID, appID, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) ClearRobotControllers(ctx context.Context, cellID CellID, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewClearRobotControllersRequest(c.Server, cellID)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) AddRobotControllerWithBody(ctx context.Context, cellID CellID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewAddRobotControllerRequestWithBody(c.Server, cellID, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) AddRobotController(ctx context.Context, cellID CellID, body AddRobotControllerJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewAddRobotControllerRequest(c.Server, cellID, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) DeleteRobotController(ctx context.Context, cellID CellID, controllerID ControllerID, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewDeleteRobotControllerRequest(c.Server, cellID, controllerID)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) UpdateRobotControllerWithBody(ctx context.Context, cellID CellID, controllerID ControllerID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdateRobotControllerRequestWithBody(c.Server, cellID, controllerID, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) UpdateRobotController(ctx context.Context, cellID CellID, controllerID ControllerID, body UpdateRobotControllerJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdateRobotControllerRequest(c.Server, cellID, controllerID, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetFoundationServices(ctx context.Context, cellID CellID, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetFoundationServicesRequest(c.Server, cellID)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) UpdateFoundationServicesWithBody(ctx context.Context, cellID CellID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdateFoundationServicesRequestWithBody(c.Server, cellID, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) UpdateFoundationServices(ctx context.Context, cellID CellID, body UpdateFoundationServicesJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdateFoundationServicesRequest(c.Server, cellID, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewStreamMotionGroupStateRequest calls the generic StreamMotionGroupState builder with application/json body
func NewStreamMotionGroupStateRequest(server string, cellID CellID, motionGroup MotionGroup, body StreamMotionGroupStateJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewStreamMotionGroupStateRequestWithBody(server, cellID, motionGroup, "application/json", bodyReader)
}

// NewStreamMotionGroupStateRequestWithBody generates requests for StreamMotionGroupState with any type of body
func NewStreamMotionGroupStateRequestWithBody(server string, cellID CellID, motionGroup MotionGroup, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
// NewStreamMoveBackwardRequest calls the generic StreamMoveBackward builder with application/json body
func NewStreamMoveBackwardRequest(server string, cellID CellID, motion Motion, body StreamMoveBackwardJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewStreamMoveBackwardRequestWithBody(server, cellID, motion, "application/json", bodyReader)
}

// NewStreamMoveBackwardRequestWithBody generates requests for StreamMoveBackward with any type of body
func NewStreamMoveBackwardRequestWithBody(server string, cellID CellID, motion Motion, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
// NewStreamMoveForwardRequest calls the generic StreamMoveForward builder with application/json body
func NewStreamMoveForwardRequest(server string, cellID CellID, motion Motion, body StreamMoveForwardJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewStreamMoveForwardRequestWithBody(server, cellID, motion, "application/json", bodyReader)
}

// NewStreamMoveForwardRequestWithBody generates requests for StreamMoveForward with any type of body
func NewStreamMoveForwardRequestWithBody(server string, cellID CellID, motion Motion, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
// NewStreamMoveToTrajectoryViaJointPTPRequest calls the generic StreamMoveToTrajectoryViaJointPTP builder with application/json body
func NewStreamMoveToTrajectoryViaJointPTPRequest(server string, cellID CellID, motion Motion, body StreamMoveToTrajectoryViaJointPTPJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewStreamMoveToTrajectoryViaJointPTPRequestWithBody(server, cellID, motion, "application/json", bodyReader)
}

// NewStreamMoveToTrajectoryViaJointPTPRequestWithBody generates requests for StreamMoveToTrajectoryViaJointPTP with any type of body
func NewStreamMoveToTrajectoryViaJointPTPRequestWithBody(server string, cellID CellID, motion Motion, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
func NewDeployCellRequest(server string, body DeployCellJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewDeployCellRequestWithBody(server, "application/json", bodyReader)
}

// NewDeployCellRequestWithBody generates requests for DeployCell with any type of body
func NewDeployCellRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
func NewDeleteCellRequest(server string, cellID CellID) (*http.Request, error) {
	var err error
...
func NewUpdateCellRequest(server string, cellID CellID, body UpdateCellJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewUpdateCellRequestWithBody(server, cellID, "application/json", bodyReader)
}

// NewUpdateCellRequestWithBody generates requests for UpdateCell with any type of body
func NewUpdateCellRequestWithBody(server string, cellID CellID, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
func NewClearAppsRequest(server string, cellID CellID) (*http.Request, error) {
	var err error
...
func NewAddAppRequest(server string, cellID CellID, body AddAppJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewAddAppRequestWithBody(server, cellID, "application/json", bodyReader)
}

// NewAddAppRequestWithBody generates requests for AddApp with any type of body
func NewAddAppRequestWithBody(server string, cellID CellID, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
func NewDeleteAppRequest(server string, cellID CellID, appID AppID) (*http.Request, error) {
	var err error
...
func NewUpdateAppRequest(server string, cellID CellID, appID AppID, body UpdateAppJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewUpdateAppRequestWithBody(server, cellID, appID, "application/json", bodyReader)
}

// NewUpdateAppRequestWithBody generates requests for UpdateApp with any type of body
func NewUpdateAppRequestWithBody(server string, cellID CellID, appID AppID, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
func NewClearRobotControllersRequest(server string, cellID CellID) (*http.Request, error) {
	var err error
...
func NewAddRobotControllerRequest(server string, cellID CellID, body AddRobotControllerJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewAddRobotControllerRequestWithBody(server, cellID, "application/json", bodyReader)
}

// NewAddRobotControllerRequestWithBody generates requests for AddRobotController with any type of body
func NewAddRobotControllerRequestWithBody(server string, cellID CellID, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
func NewDeleteRobotControllerRequest(server string, cellID CellID, controllerID ControllerID) (*http.Request, error) {
	var err error
...
func NewUpdateRobotControllerRequest(server string, cellID CellID, controllerID ControllerID, body UpdateRobotControllerJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewUpdateRobotControllerRequestWithBody(server, cellID, controllerID, "application/json", bodyReader)
}

// NewUpdateRobotControllerRequestWithBody generates requests for UpdateRobotController with any type of body
func NewUpdateRobotControllerRequestWithBody(server string, cellID CellID, controllerID ControllerID, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
// NewGetFoundationServicesRequest generates requests for GetFoundationServices
func NewGetFoundationServicesRequest(server string, cellID CellID) (*http.Request, error) {
	var err error
...
// NewUpdateFoundationServicesRequest calls the generic UpdateFoundationServices builder with application/json body
func NewUpdateFoundationServicesRequest(server string, cellID CellID, body UpdateFoundationServicesJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewUpdateFoundationServicesRequestWithBody(server, cellID, "application/json", bodyReader)
}

// NewUpdateFoundationServicesRequestWithBody generates requests for UpdateFoundationServices with any type of body
func NewUpdateFoundationServicesRequestWithBody(server string, cellID CellID, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	// StreamMotionGroupStateWithBodyWithResponse request with any body
	StreamMotionGroupStateWithBodyWithResponse(ctx context.Context, cellID CellID, motionGroup MotionGroup, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*StreamMotionGroupStateResp, error)

	StreamMotionGroupStateWithResponse(ctx context.Context, cellID CellID, motionGroup MotionGroup, body StreamMotionGroupStateJSONRequestBody, reqEditors ...RequestEditorFn) (*StreamMotionGroupStateResp, error)
	...
	// StreamMoveBackwardWithBodyWithResponse request with any body
	StreamMoveBackwardWithBodyWithResponse(ctx context.Context, cellID CellID, motion Motion, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*StreamMoveBackwardResp, error)

	StreamMoveBackwardWithResponse(ctx context.Context, cellID CellID, motion Motion, body StreamMoveBackwardJSONRequestBody, reqEditors ...RequestEditorFn) (*StreamMoveBackwardResp, error)

	// StreamMoveForwardWithBodyWithResponse request with any body
	StreamMoveForwardWithBodyWithResponse(ctx context.Context, cellID CellID, motion Motion, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*StreamMoveForwardResp, error)

	StreamMoveForwardWithResponse(ctx context.Context, cellID CellID, motion Motion, body StreamMoveForwardJSONRequestBody, reqEditors ...RequestEditorFn) (*StreamMoveForwardResp, error)

	// StreamMoveToTrajectoryViaJointPTPWithBodyWithResponse request with any body
	StreamMoveToTrajectoryViaJointPTPWithBodyWithResponse(ctx context.Context, cellID CellID, motion Motion, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*StreamMoveToTrajectoryViaJointPTPResp, error)

	StreamMoveToTrajectoryViaJointPTPWithResponse(ctx context.Context, cellID CellID, motion Motion, body StreamMoveToTrajectoryViaJointPTPJSONRequestBody, reqEditors ...RequestEditorFn) (*StreamMoveToTrajectoryViaJointPTPResp, error)
	...
	DeployCellWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*DeployCellResp, error)

	DeployCellWithResponse(ctx context.Context, body DeployCellJSONRequestBody, reqEditors ...RequestEditorFn) (*DeployCellResp, error)

	// DeleteCellWithResponse request
	DeleteCellWithResponse(ctx context.Context, cellID CellID, reqEditors ...RequestEditorFn) (*DeleteCellResp, error)
	...
	UpdateCellWithBodyWithResponse(ctx context.Context, cellID CellID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateCellResp, error)

	UpdateCellWithResponse(ctx context.Context, cellID CellID, body UpdateCellJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateCellResp, error)

	// ClearAppsWithResponse request
	ClearAppsWithResponse(ctx context.Context, cellID CellID, reqEditors ...RequestEditorFn) (*ClearAppsResp, error)
	...
	AddAppWithBodyWithResponse(ctx context.Context, cellID CellID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*AddAppResp, error)

	AddAppWithResponse(ctx context.Context, cellID CellID, body AddAppJSONRequestBody, reqEditors ...RequestEditorFn) (*AddAppResp, error)

	// DeleteAppWithResponse request
	DeleteAppWithResponse(ctx context.Context, cellID CellID, appID AppID, reqEditors ...RequestEditorFn) (*DeleteAppResp, error)
	...
	UpdateAppWithBodyWithResponse(ctx context.Context, cellID CellID, appID AppID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateAppResp, error)

	UpdateAppWithResponse(ctx context.Context, cellID CellID, appID AppID, body UpdateAppJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateAppResp, error)

	// ClearRobotControllersWithResponse request
	ClearRobotControllersWithResponse(ctx context.Context, cellID CellID, reqEditors ...RequestEditorFn) (*ClearRobotControllersResp, error)
	...
	AddRobotControllerWithBodyWithResponse(ctx context.Context, cellID CellID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*AddRobotControllerResp, error)

	AddRobotControllerWithResponse(ctx context.Context, cellID CellID, body AddRobotControllerJSONRequestBody, reqEditors ...RequestEditorFn) (*AddRobotControllerResp, error)

	// DeleteRobotControllerWithResponse request
	DeleteRobotControllerWithResponse(ctx context.Context, cellID CellID, controllerID ControllerID, reqEditors ...RequestEditorFn) (*DeleteRobotControllerResp, error)
	...
	UpdateRobotControllerWithBodyWithResponse(ctx context.Context, cellID CellID, controllerID ControllerID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateRobotControllerResp, error)

	UpdateRobotControllerWithResponse(ctx context.Context, cellID CellID, controllerID ControllerID, body UpdateRobotControllerJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateRobotControllerResp, error)

	// GetFoundationServicesWithResponse request
	GetFoundationServicesWithResponse(ctx context.Context, cellID CellID, reqEditors ...RequestEditorFn) (*GetFoundationServicesResp, error)

	// UpdateFoundationServicesWithBodyWithResponse request with any body
	UpdateFoundationServicesWithBodyWithResponse(ctx context.Context, cellID CellID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateFoundationServicesResp, error)

	UpdateFoundationServicesWithResponse(ctx context.Context, cellID CellID, body UpdateFoundationServicesJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateFoundationServicesResp, error)
...
type GetFoundationServicesResp struct {
	Body         []byte
	HTTPResponse *http.Response
...
// Status returns HTTPResponse.Status
func (r GetFoundationServicesResp) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetFoundationServicesResp) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type UpdateFoundationServicesResp struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON404      *NotFound
}
...
// Status returns HTTPResponse.Status
func (r UpdateFoundationServicesResp) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r UpdateFoundationServicesResp) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// StreamMotionGroupStateWithBodyWithResponse request with arbitrary body returning *StreamMotionGroupStateResp
func (c *ClientWithResponses) StreamMotionGroupStateWithBodyWithResponse(ctx context.Context, cellID CellID, motionGroup MotionGroup, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*StreamMotionGroupStateResp, error) {
	rsp, err := c.StreamMotionGroupStateWithBody(ctx, cellID, motionGroup, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) StreamMotionGroupStateWithResponse(ctx context.Context, cellID CellID, motionGroup MotionGroup, body StreamMotionGroupStateJSONRequestBody, reqEditors ...RequestEditorFn) (*StreamMotionGroupStateResp, error) {
	rsp, err := c.StreamMotionGroupState(ctx, cellID, motionGroup, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseStreamMotionGroupStateResp(rsp)
...
// StreamMoveBackwardWithBodyWithResponse request with arbitrary body returning *StreamMoveBackwardResp
func (c *ClientWithResponses) StreamMoveBackwardWithBodyWithResponse(ctx context.Context, cellID CellID, motion Motion, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*StreamMoveBackwardResp, error) {
	rsp, err := c.StreamMoveBackwardWithBody(ctx, cellID, motion, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) StreamMoveBackwardWithResponse(ctx context.Context, cellID CellID, motion Motion, body StreamMoveBackwardJSONRequestBody, reqEditors ...RequestEditorFn) (*StreamMoveBackwardResp, error) {
	rsp, err := c.StreamMoveBackward(ctx, cellID, motion, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseStreamMoveBackwardResp(rsp)
...
// StreamMoveForwardWithBodyWithResponse request with arbitrary body returning *StreamMoveForwardResp
func (c *ClientWithResponses) StreamMoveForwardWithBodyWithResponse(ctx context.Context, cellID CellID, motion Motion, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*StreamMoveForwardResp, error) {
	rsp, err := c.StreamMoveForwardWithBody(ctx, cellID, motion, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) StreamMoveForwardWithResponse(ctx context.Context, cellID CellID, motion Motion, body StreamMoveForwardJSONRequestBody, reqEditors ...RequestEditorFn) (*StreamMoveForwardResp, error) {
	rsp, err := c.StreamMoveForward(ctx, cellID, motion, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseStreamMoveForwardResp(rsp)
...
// StreamMoveToTrajectoryViaJointPTPWithBodyWithResponse request with arbitrary body returning *StreamMoveToTrajectoryViaJointPTPResp
func (c *ClientWithResponses) StreamMoveToTrajectoryViaJointPTPWithBodyWithResponse(ctx context.Context, cellID CellID, motion Motion, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*StreamMoveToTrajectoryViaJointPTPResp, error) {
	rsp, err := c.StreamMoveToTrajectoryViaJointPTPWithBody(ctx, cellID, motion, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) StreamMoveToTrajectoryViaJointPTPWithResponse(ctx context.Context, cellID CellID, motion Motion, body StreamMoveToTrajectoryViaJointPTPJSONRequestBody, reqEditors ...RequestEditorFn) (*StreamMoveToTrajectoryViaJointPTPResp, error) {
	rsp, err := c.StreamMoveToTrajectoryViaJointPTP(ctx, cellID, motion, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseStreamMoveToTrajectoryViaJointPTPResp(rsp)
...
func (c *ClientWithResponses) DeployCellWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*DeployCellResp, error) {
	rsp, err := c.DeployCellWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) DeployCellWithResponse(ctx context.Context, body DeployCellJSONRequestBody, reqEditors ...RequestEditorFn) (*DeployCellResp, error) {
	rsp, err := c.DeployCell(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseDeployCellResp(rsp)
...
func (c *ClientWithResponses) DeleteCellWithResponse(ctx context.Context, cellID CellID, reqEditors ...RequestEditorFn) (*DeleteCellResp, error) {
	rsp, err := c.DeleteCell(ctx, cellID, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) UpdateCellWithBodyWithResponse(ctx context.Context, cellID CellID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateCellResp, error) {
	rsp, err := c.UpdateCellWithBody(ctx, cellID, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) UpdateCellWithResponse(ctx context.Context, cellID CellID, body UpdateCellJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateCellResp, error) {
	rsp, err := c.UpdateCell(ctx, cellID, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUpdateCellResp(rsp)
...
func (c *ClientWithResponses) ClearAppsWithResponse(ctx context.Context, cellID CellID, reqEditors ...RequestEditorFn) (*ClearAppsResp, error) {
	rsp, err := c.ClearApps(ctx, cellID, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) AddAppWithBodyWithResponse(ctx context.Context, cellID CellID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*AddAppResp, error) {
	rsp, err := c.AddAppWithBody(ctx, cellID, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) AddAppWithResponse(ctx context.Context, cellID CellID, body AddAppJSONRequestBody, reqEditors ...RequestEditorFn) (*AddAppResp, error) {
	rsp, err := c.AddApp(ctx, cellID, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseAddAppResp(rsp)
...
func (c *ClientWithResponses) DeleteAppWithResponse(ctx context.Context, cellID CellID, appID AppID, reqEditors ...RequestEditorFn) (*DeleteAppResp, error) {
	rsp, err := c.DeleteApp(ctx, cellID, appID, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) UpdateAppWithBodyWithResponse(ctx context.Context, cellID CellID, appID AppID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateAppResp, error) {
	rsp, err := c.UpdateAppWithBody(ctx, cellID, appID, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) UpdateAppWithResponse(ctx context.Context, cellID CellID, appID AppID, body UpdateAppJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateAppResp, error) {
	rsp, err := c.UpdateApp(ctx, cellID, appID, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUpdateAppResp(rsp)
...
func (c *ClientWithResponses) ClearRobotControllersWithResponse(ctx context.Context, cellID CellID, reqEditors ...RequestEditorFn) (*ClearRobotControllersResp, error) {
	rsp, err := c.ClearRobotControllers(ctx, cellID, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) AddRobotControllerWithBodyWithResponse(ctx context.Context, cellID CellID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*AddRobotControllerResp, error) {
	rsp, err := c.AddRobotControllerWithBody(ctx, cellID, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) AddRobotControllerWithResponse(ctx context.Context, cellID CellID, body AddRobotControllerJSONRequestBody, reqEditors ...RequestEditorFn) (*AddRobotControllerResp, error) {
	rsp, err := c.AddRobotController(ctx, cellID, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseAddRobotControllerResp(rsp)
...
func (c *ClientWithResponses) DeleteRobotControllerWithResponse(ctx context.Context, cellID CellID, controllerID ControllerID, reqEditors ...RequestEditorFn) (*DeleteRobotControllerResp, error) {
	rsp, err := c.DeleteRobotController(ctx, cellID, controllerID, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) UpdateRobotControllerWithBodyWithResponse(ctx context.Context, cellID CellID, controllerID ControllerID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateRobotControllerResp, error) {
	rsp, err := c.UpdateRobotControllerWithBody(ctx, cellID, controllerID, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) UpdateRobotControllerWithResponse(ctx context.Context, cellID CellID, controllerID ControllerID, body UpdateRobotControllerJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateRobotControllerResp, error) {
	rsp, err := c.UpdateRobotController(ctx, cellID, controllerID, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUpdateRobotControllerResp(rsp)
...
// GetFoundationServicesWithResponse request returning *GetFoundationServicesResp
func (c *ClientWithResponses) GetFoundationServicesWithResponse(ctx context.Context, cellID CellID, reqEditors ...RequestEditorFn) (*GetFoundationServicesResp, error) {
	rsp, err := c.GetFoundationServices(ctx, cellID, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetFoundationServicesResp(rsp)
}

// UpdateFoundationServicesWithBodyWithResponse request with arbitrary body returning *UpdateFoundationServicesResp
func (c *ClientWithResponses) UpdateFoundationServicesWithBodyWithResponse(ctx context.Context, cellID CellID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateFoundationServicesResp, error) {
	rsp, err := c.UpdateFoundationServicesWithBody(ctx, cellID, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUpdateFoundationServicesResp(rsp)
}

func (c *ClientWithResponses) UpdateFoundationServicesWithResponse(ctx context.Context, cellID CellID, body UpdateFoundationServicesJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateFoundationServicesResp, error) {
	rsp, err := c.UpdateFoundationServices(ctx, cellID, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUpdateFoundationServicesResp(rsp)
...
// ParseGetFoundationServicesResp parses an HTTP response from a GetFoundationServicesWithResponse call
func ParseGetFoundationServicesResp(rsp *http.Response) (*GetFoundationServicesResp, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &GetFoundationServicesResp{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseUpdateFoundationServicesResp parses an HTTP response from a UpdateFoundationServicesWithResponse call
func ParseUpdateFoundationServicesResp(rsp *http.Response) (*UpdateFoundationServicesResp, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &UpdateFoundationServicesResp{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
