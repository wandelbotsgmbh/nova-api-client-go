...
const (
	...
	MotionGroupModelYaskawaHC10DT        MotionGroupModel = "Yaskawa_HC10DT"
	MotionGroupModelYaskawaHC20DT        MotionGroupModel = "Yaskawa_HC20DT"
...
const (
	...
	GetDefaultLinkChainParamsMotionGroupModelYaskawaHC10DT        GetDefaultLinkChainParamsMotionGroupModel = "Yaskawa_HC10DT"
	GetDefaultLinkChainParamsMotionGroupModelYaskawaHC20DT        GetDefaultLinkChainParamsMotionGroupModel = "Yaskawa_HC20DT"
...
type Movement struct {
	Movement struct {
		...
		CurrentLocation *float64 `json:"current_location,omitempty"`
...
type PlaybackSpeedResponse struct {
	PlaybackSpeedResponse struct {
		...
		RequestedValue *uint32 `json:"requested_value,omitempty"`
...
type ActivateLicenseJSONBody struct {
	OwnerAuthToken    string `json:"owner_auth_token"`
