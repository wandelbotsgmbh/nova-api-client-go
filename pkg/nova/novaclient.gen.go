...
// PauseOnIOAction Defines an I/O that the motion will be paused for. The motion will stop gracefully on path.
type PauseOnIOAction = PauseOnIO
...
// SetIOAction Defines I/Os that should be set upon reaching the given location on the trajectory.
type SetIOAction = []SetIO

// StartOnIOAction Defines an I/O that the motion should wait for to start the execution.
type StartOnIOAction = StartOnIO
...
type StreamMoveBackwardParams struct {
	...
	SetIOAction *SetIOAction `form:"set_ios,omitempty" json:"set_ios,omitempty"`

	// StartOnIOAction Defines an I/O that is listened to during the motion. If the defined comparator evaluates to true the execution is started.
	StartOnIOAction *StartOnIOAction `form:"start_on_io,omitempty" json:"start_on_io,omitempty"`

	// PauseOnIOAction Defines an I/O that is listened to during the motion. If the defined comparator evaluates to true the execution is paused.
	PauseOnIOAction *PauseOnIOAction `form:"pause_on_io,omitempty" json:"pause_on_io,omitempty"`
}
...
func NewStreamMoveBackwardRequest(server string, cellID CellID, motion Motion, params *StreamMoveBackwardParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.SetIOAction != nil {

			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "set_ios", runtime.ParamLocationQuery, *params.SetIOAction); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
		...
		if params.StartOnIOAction != nil {

			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "start_on_io", runtime.ParamLocationQuery, *params.StartOnIOAction); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
		...
		if params.PauseOnIOAction != nil {

			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "pause_on_io", runtime.ParamLocationQuery, *params.PauseOnIOAction); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
